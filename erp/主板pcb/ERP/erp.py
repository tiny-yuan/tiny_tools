    ...
    def data(self):
        ...
        # 编写sql语句
            for i in range(1,row_num):
                        ...
                        print("insert into erp.bom_item (main_meterial,sub_meterial,quantity,description) values('{}','{}','{}','{}')".format(ERP.sub_meterrial,row_content[0],row_content[3],row_content[4]), file = f)
