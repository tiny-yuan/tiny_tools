...
class ERP:
    ...
    def data(self):
        # 获取excel数据
        # 打开excel表格
        wordbook = xlrd.open_workbook('./ERP/bom.xls')
        # 选择sheet页数
        ...
        # 编写sql语句
            for i in range(1,row_num):
                        ...
                        print("insert into erp.bom_item (main_meterial,sub_meterial,quantity,description) values('{}','%.0f','%.0f','{}')".format(ERP.sub_meterrial,row_content[4]) %(row_content[1],row_content[3]), file = f)
